...
public 레포는 표준 러너가 무제한 무료입니다. private 레포는 플랜별 무료 분을 씁니다.
...
Linux 러너는 배수 1배입니다 (Windows 2배, macOS 10배). 작업 시간은 분 단위로 올림됩니다.

⚠️ **무료 분을 다 쓰면 결제 수단이 없는 계정은 실행이 차단됩니다.** 백업이 그 달 남은 기간
동안 조용히 멈춘다는 뜻입니다. 첫 실행 뒤 Actions 탭에서 소요 시간을 확인하고
`소요 시간 x 30 < 무료 분` 인지 계산해 보세요. 초과할 것 같으면 cron 을 격일이나 주 1회로
낮추는 것이 가장 간단합니다. 사용량은 <https://github.com/settings/billing> 에서 봅니다.
